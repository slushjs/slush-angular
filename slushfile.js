...
gulp.task('default', function (done) {
  inquirer.prompt([
    ...
    {type: 'confirm', name: 'middleware', message: 'Do you want to use middleware for proxy support? If you choose Yes, then the live-relead may not work.', default: false},
